...
public final class VirtualNetworkGatewayConnectionsInner implements InnerSupportsGet<VirtualNetworkGatewayConnectionInner>, InnerSupportsDelete<Void> {
     ...
     */
    public ConnectionSharedKeyInner beginSetSharedKey(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value) {
        return beginSetSharedKeyAsync(resourceGroupName, virtualNetworkGatewayConnectionName, value).blockingLast().result();
    }
     ...
     */
    public ServiceFuture<ConnectionSharedKeyInner> beginSetSharedKeyAsync(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value, ServiceCallback<ConnectionSharedKeyInner> serviceCallback) {
        return ServiceFutureUtil.fromLRO(beginSetSharedKeyAsync(resourceGroupName, virtualNetworkGatewayConnectionName, value), serviceCallback);
    }
     ...
     * @return the observable for the request.
     */
    public Observable<OperationStatus<ConnectionSharedKeyInner>> beginSetSharedKeyAsync(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (virtualNetworkGatewayConnectionName == null) {
        ...
        return service.beginSetSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), parameters);
    }
     ...
     * @return the ConnectionSharedKeyInner object if successful.
     */
    public ConnectionSharedKeyInner setSharedKey(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value) {
        return setSharedKeyAsync(resourceGroupName, virtualNetworkGatewayConnectionName, value).blockingGet();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<ConnectionSharedKeyInner> setSharedKeyAsync(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value, ServiceCallback<ConnectionSharedKeyInner> serviceCallback) {
        return ServiceFuture.fromBody(setSharedKeyAsync(resourceGroupName, virtualNetworkGatewayConnectionName, value), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<BodyResponse<ConnectionSharedKeyInner>> setSharedKeyWithRestResponseAsync(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (virtualNetworkGatewayConnectionName == null) {
        ...
        ConnectionSharedKeyInner parameters = new ConnectionSharedKeyInner();
        parameters.withValue(value);
        return service.setSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), parameters);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Maybe<ConnectionSharedKeyInner> setSharedKeyAsync(@NonNull String resourceGroupName, @NonNull String virtualNetworkGatewayConnectionName, @NonNull String value) {
        return setSharedKeyWithRestResponseAsync(resourceGroupName, virtualNetworkGatewayConnectionName, value)
