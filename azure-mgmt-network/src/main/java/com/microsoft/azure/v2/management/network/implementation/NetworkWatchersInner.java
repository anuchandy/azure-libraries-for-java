...
public final class NetworkWatchersInner implements InnerSupportsGet<NetworkWatcherInner>, InnerSupportsDelete<Void>, InnerSupportsListing<NetworkWatcherInner> {
     ...
     */
    public TopologyInner getTopology(@NonNull String resourceGroupName, @NonNull String networkWatcherName, @NonNull String targetResourceGroupName) {
        return getTopologyAsync(resourceGroupName, networkWatcherName, targetResourceGroupName).blockingGet();
    }
     ...
     * @return a ServiceFuture which will be completed with the result of the network request.
     */
    public ServiceFuture<TopologyInner> getTopologyAsync(@NonNull String resourceGroupName, @NonNull String networkWatcherName, @NonNull String targetResourceGroupName, ServiceCallback<TopologyInner> serviceCallback) {
        return ServiceFuture.fromBody(getTopologyAsync(resourceGroupName, networkWatcherName, targetResourceGroupName), serviceCallback);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Single<BodyResponse<TopologyInner>> getTopologyWithRestResponseAsync(@NonNull String resourceGroupName, @NonNull String networkWatcherName, @NonNull String targetResourceGroupName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (networkWatcherName == null) {
        ...
        return service.getTopology(resourceGroupName, networkWatcherName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), parameters);
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Maybe<TopologyInner> getTopologyAsync(@NonNull String resourceGroupName, @NonNull String networkWatcherName, @NonNull String targetResourceGroupName) {
        return getTopologyWithRestResponseAsync(resourceGroupName, networkWatcherName, targetResourceGroupName)
    ...
    /**
     * Configures flow log on a specified resource. (resume watch).
     *
     * @param operationDescription The OperationDescription object.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @return the observable for the request.
    ...
    /**
     * Queries status of flow log on a specified resource. (resume watch).
     *
     * @param operationDescription The OperationDescription object.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @return the observable for the request.
